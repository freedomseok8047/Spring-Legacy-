...
<body>
 <h1>답글쓰기</h1>
  <form name="frmReply" method="post"  action="${contextPath}/board/addReply.do?${parentNo}"   enctype="multipart/form-data">
    <table>
    <tr>
		...
		<tr>
			...
			<td><input type=button value="비밀번호 확인" onClick="passwordConfirm(inputPassword.value)" /> </td>
		</tr>
		<tr>
		...
		<tr>
			<td align="right"> </td>
			<td>
				<input id="submitBtn" type=submit value="답글쓰기" />
				<input type=button value="취소" onClick="return checkSubmit() />
